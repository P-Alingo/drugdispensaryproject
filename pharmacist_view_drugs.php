...
if (isset($_SESSION['full_name'])) {
    // Retrieve the pharmacist's name from the session
...
<head>
    <style>
      ...
      background-position: center; /* Center the background image */
        ...
        th {
            background-color: indigo; /* Update the background color to indigo */
            color: white;
        }

        a {
            color: indigo; /* Update the color to black */
...
<body>
    ...
    <a class="back-button" href="pharmacistpage.php">Back</a>
</body>
</html>