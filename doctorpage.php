...
<p>Click here to view the patient's appointments</p>
</div>
<div class="card">
<button onclick="window.location.href='Doctor_prescription.php'" class="button">Prescription</button>
<p>Click here to view the patient's prescriptions</p>
</div>
<div class="card">
<button onclick="window.location.href='doctor_view_drugs.php'" class="button">Available drugs</button>
<p>Click here to view the drug's details</p>
</div>
</div>

<a href="project.html" class="logout-button">Log Out</a>
